  ...
  <div class="wrap">
    <main class="card" aria-labelledby="welcomeTitle">
      <section class="left">
        ...
        <form action="BRegister.jsp">
        <div class="tabs">
          <div class="tab active" data-tab="login">Login</div>
          <a href="index.html"></a>
          <button class="btn" type="submit" class="tab active">Register</button>
          </div>
         </form>
        <form class="form" id="loginForm"  action="BuyerReg2.jsp">
          <label class="input">
            <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="4" width="20" height="16" rx="3"/><path d="M22 7L12 13 2 7"/></svg>
          ...
          <label class="input">
            ...
            <input id="pwdLogin" type="password" placeholder="Password" required aria-label="Password" />
            <button class="peek" type="button" onclick="togglePwd('pwdLogin', this)"><svg width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8S1 12 1 12z"/><circle cx="12" cy="12" r="3"/></svg></button>
          </label>
          <div class="actions">
         ...
         <div class="actions">
          ...
          <div class="links">
            <span><a href="BRegister.jsp">Forgot Password?</a></span>
          </div>
             </section>
